...
3. **Minigame UI not visible?** → [UI Toolkit: Minigame UI Not Visible](./UI-Toolkit.md#minigame-ui-not-visible--gets-hidden) 🆕
...
| "Minigame UI shown but nothing visible" 🆕 | UI Toolkit | Minigame UI Issues |
